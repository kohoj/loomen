...
- Continue splitting `src-tauri/src/main.rs` into domain modules; Pulse command discovery/evidence and PTY terminal sessions/snapshots now live behind Rust module boundaries, with persistence, git, sidecar, review, GitHub, settings, and app bootstrap still to follow.
